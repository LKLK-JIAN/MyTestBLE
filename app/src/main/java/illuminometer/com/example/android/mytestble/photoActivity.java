...
import illuminometer.com.example.android.mytestble.adapter.MylistphoteAdapter;
...
public class photoActivity extends AppCompatActivity {
    ...
    public static ArrayList fileNames = null;
    Handler handler;
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        ...
        show_list = (ListView) findViewById(R.id.list);
        look.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                //设置adapter
//                SimpleAdapter adapter=new SimpleAdapter(photoActivity.this,listItems,
//                        R.layout.line, new String[]{"name", "desc"}, new int[]{R.id.name, R.id.desc});
        ...
        show_list.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                new AlertDialog.Builder(photoActivity.this).setView(viewDiag)
